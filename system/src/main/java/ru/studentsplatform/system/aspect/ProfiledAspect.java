package ru.studentsplatform.system.aspect;
...
public class ProfiledAspect {
	...
	@Pointcut("@within(ru.studentsplatform.system.annotation.Profiled)" +
			" || @annotation(ru.studentsplatform.system.annotation.Profiled)")
	 ...
	 */
	@Around("@within(ru.studentsplatform.system.annotation.Profiled)" +
			" || @annotation(ru.studentsplatform.system.annotation.Profiled)")
